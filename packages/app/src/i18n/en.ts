...
export const dict = {
  "session.device.flutter.reload": "Hot Reload",
  "session.device.flutter.restart": "Hot Restart",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in MobileCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in MobileCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in MobileCode.",
  ...
  "dialog.server.description": "Switch which MobileCode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "MobileCode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking MobileCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking MobileCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating MobileCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating MobileCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update MobileCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update MobileCode",
  "wsl.onboarding.opencodeReadyIn": "MobileCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "MobileCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install MobileCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install MobileCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "MobileCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before MobileCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "MobileCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen MobileCode.",
  ...
  "help.tabs.introduction": "MobileCode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of MobileCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the MobileCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, MobileCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "MobileCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "MobileCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the MobileCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for MobileCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how MobileCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether MobileCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how MobileCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when MobileCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of MobileCode.",
  ...
  "session.tab.device": "Device",
  "command.session.device": "Toggle device preview",
  "session.device.platform.ios": "iOS Simulator",
  "session.device.platform.android": "Android Emulator",
  "session.device.start": "Start",
  "session.device.stop": "Stop",
  "session.device.restart": "Restart",
  "session.device.reload": "Reload",
  "session.device.openExternal": "Open in browser",
  "session.device.status.starting": "Starting {{command}}…",
  "session.device.status.stopped": "The preview server is not running.",
  "session.device.status.exited": "The preview server exited.",
  "session.device.status.notDetected": "No iOS or Android project was detected in this directory.",
  "session.device.run.play": "Build and run on {{platform}}",
  "session.device.run.stop": "Stop running on {{platform}}",
  "session.device.run.running": "Running",
  "session.device.run.building": "Building",
