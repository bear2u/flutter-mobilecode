  ...
  return createRoot((disposeRoot) => {
    ...
    return {
      shared: {
        ...
        reloadApp: (platform: DevicePreview.Platform, action: "reload" | "restart") =>
          act(api.reloadApp(directory, platform, action)),
...
export function createDeviceState() {
  ...
  return {
    ...
    reloadApp: (value: DevicePreview.Platform, action: "reload" | "restart") => shared().reloadApp(value, action),
