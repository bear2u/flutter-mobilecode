...
export type DevicePreviewGetOutput = {
  ...
  readonly data: {
    ...
    readonly framework?: "expo" | "react-native" | "native" | "flutter"
    readonly bundler?: {
      readonly framework: "expo" | "react-native" | "native" | "flutter"
      readonly directory: string
...
export type DevicePreviewRunAppInput = {
  ...
  readonly platform: {
    readonly platform: "ios" | "android"
    readonly action?: "reload" | "restart"
...
export type DevicePreviewFocusInput = {
  readonly location?: {
    readonly location?: { readonly directory?: string | undefined; readonly workspace?: string | undefined } | undefined
  }["location"]
}

export type DevicePreviewFocusOutput = {
  readonly location: {
    readonly directory: string
    readonly workspaceID?: string
    readonly project: { readonly id: string; readonly directory: string }
